...
switch(action.type){
    case 'ADD_USER':
        const {id, first_name, last_name, username, is_student, total_points, streak, all_vocab, rewards_hash, money_spent, balance, image_url } = action.payload

        return {
            ...state, 
            currentUser: {id, first_name, last_name, username, is_student, total_points, streak, all_vocab, rewards_hash, money_spent, balance, image_url}
        }
    // case 'HANDLE_STREAK':
